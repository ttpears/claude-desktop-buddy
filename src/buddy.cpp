...
// M5.Display for landscape clock mode (both derive from LovyanGFX). Coords
...
// One-shot render to an arbitrary surface (M5.Display for landscape
...
void buddyRenderTo(GfxSurface* tgt, uint8_t personaState) {
